  ...
  useEffect(()=>{
    ...
    try {
      const res= await axios.get("/user?new=true",
      {
        headers:
        {
         "auth-token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyMSI6eyJpZCI6IjYyYTZjMTUwMzViNzZlZjFiMWZhYjVkYiIsImlzQWRtaW4iOnRydWV9LCJpYXQiOjE2NTUzNjI3NTYsImV4cCI6MTY1NTc5NDc1Nn0.OGy4tQ5cAx4QzJOtanXR-ruIwlsT3TagNuG8lxmDDnc"
        }
      }
      );
